...
?>
	...
	<div class="archive-box">
		<div class="container title-bar">
			...
			<span><?php _e( 'Browse Category', 'pencidesign' ); ?></span>
			<h1><?php printf( __( '%s', 'pencidesign' ), single_cat_title( '', false ) ); ?></h1>
		</div>
	</div>
	...
	<div class="container<?php echo esc_attr( $class_layout ); if ( get_theme_mod( 'penci_sidebar_archive' ) ) : ?> penci_sidebar<?php endif; ?>">
		<div id="main"<?php echo wp_kses( $class_border, '' ); ?>>
			...
			<?php if ( category_description() ) : // Show an optional category description ?>
				<div class="penci-category-description"><?php echo category_description(); ?></div>
			<?php endif; ?>
