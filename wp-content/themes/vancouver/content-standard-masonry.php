<?php
/**
 * Content standard masonry homepage, archive page
 *
 * @since 1.0
 */
?>
<article id="post-<?php the_ID(); ?>" class="item item-masonry standard-masonry">
				...
				<div class="standard-post-image">
					<div class="penci-slick-slider" data-auto-height="true">
						<?php foreach ( $images as $image ) : ?>
							...
							<?php $the_image = wp_get_attachment_image_src( $image, 'portfolio-detail' ); ?>
		...
		<?php else : ?>
			...
			<?php if ( has_post_thumbnail() ) : ?>
				<?php if ( ! get_theme_mod( 'penci_post_thumb' ) ) : ?>
					<div class="standard-post-image">
						<a href="<?php the_permalink() ?>"><?php the_post_thumbnail( 'portfolio-detail' ); ?></a>
	...
	<div class="standard-content">
		...
		<div class="standard-main-content<?php if ( ! get_theme_mod( 'penci_standard_share_box' ) ) : echo ' has-padding'; endif; ?>">
			...
			<div class="standard-post-entry">
				<?php the_excerpt(); ?>
				<p><a href="<?php the_permalink(); ?>" class="more-link"><?php _e( 'Continue Reading', 'pencidesign' ); ?></a></p>
			</div>
		</div>
	</div>
