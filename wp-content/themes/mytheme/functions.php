...
function twentysixteen_scripts() {
    ...
    wp_enqueue_style( 'twentysixteen-style', get_stylesheet_uri(), array(), '20160414');
	...
	wp_enqueue_script( 'twentysixteen-script', get_template_directory_uri() . '/js/main.js', array( 'jquery' ), '20160410', true );
