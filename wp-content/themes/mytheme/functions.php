...
function twentysixteen_scripts() {
    ...
    wp_enqueue_style( 'twentysixteen-style', get_stylesheet_uri(), array(), '20160812');
	...
	wp_enqueue_script( 'swipe', get_template_directory_uri() . '/js/swipe.js', array(), '20160812', true );
