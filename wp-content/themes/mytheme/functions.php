...
function twentysixteen_scripts() {
	...
	wp_enqueue_style( 'icons-style', get_template_directory_uri() . '/css/icons.css');
	...
	wp_enqueue_script( 'headroom', get_template_directory_uri() . '/js/headroom.min.js', array( 'jquery' ), '20160309', true );
