...
function twentysixteen_scripts() {
	...
	// Theme stylesheet.
	wp_enqueue_style( 'fonts-style', get_template_directory_uri() . '/css/font.css', array(), '20160406');
	wp_enqueue_style( 'bootstrap-style', get_template_directory_uri() . '/css/bootstrap.min.css', array(), '20160406');
	wp_enqueue_style( 'icons-style', get_template_directory_uri() . '/css/icons.css', array(), '20160406');
    wp_enqueue_style( 'twentysixteen-style', get_stylesheet_uri(), array(), '20160406');
	...
	wp_enqueue_script( 'bootstrap-js', get_template_directory_uri() . '/js/bootstrap.min.js', array( 'jquery' ), '20160406', true );
	wp_enqueue_script( 'twentysixteen-script', get_template_directory_uri() . '/js/main.js', array( 'jquery' ), '20160406', true );
	wp_enqueue_script( 'headroom', get_template_directory_uri() . '/js/headroom.min.js', array( 'jquery' ), '20160406', true );
	wp_enqueue_script( 'swipe', get_template_directory_uri() . '/js/swipe.js', array(), '20160406', true );
