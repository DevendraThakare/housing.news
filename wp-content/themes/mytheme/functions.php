...
function twentysixteen_scripts() {
    ...
    wp_enqueue_style( 'twentysixteen-style', get_stylesheet_uri(), array(), '20160517');
	...
	wp_enqueue_script( 'bootstrap-js', get_template_directory_uri() . '/js/bootstrap.min.js', array( 'jquery' ), '20160409', true );
	wp_enqueue_script( 'twentysixteen-script', get_template_directory_uri() . '/js/main.js', array( 'jquery' ), '20160510', true );
	wp_enqueue_script( 'headroom', get_template_directory_uri() . '/js/headroom.min.js', array( 'jquery' ), '20160505', true );
	wp_enqueue_script( 'swipe', get_template_directory_uri() . '/js/swipe.js', array(), '20160409', true );
